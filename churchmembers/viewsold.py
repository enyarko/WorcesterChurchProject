...
def edit_guest(request, guest_id):
    ...
    if request.method == "POST":
        guest.date = request.POST.get("date") or None
        guest.name = request.POST.get("name")
        guest.address = request.POST.get("address")
        guest.city = request.POST.get("city")
        guest.state = request.POST.get("state")
        guest.zip_code = request.POST.get("zip_code")
        guest.phone_home = request.POST.get("phone_home")
        guest.phone_mobile = request.POST.get("phone_mobile")
        guest.email = request.POST.get("email")
        guest.age_group = request.POST.get("age_group")
        guest.children_at_home = request.POST.get("children_at_home")
        guest.number_of_children = request.POST.get("number_of_children") or None
        guest.home_church = request.POST.get("home_church")
        guest.guest_of = request.POST.get("guest_of")
        guest.save()

        messages.success(request, "Guest information updated successfully.")
        return redirect("guest_detail", guest_id=guest.id)

    return render(request, "churchmembers/edit_guest.html", {"guest": guest})
...
def media_home(request):
    ...
    return render(request, "media_center/media_home.html", {
        "featured": featured,
        "latest": latest,
    })
